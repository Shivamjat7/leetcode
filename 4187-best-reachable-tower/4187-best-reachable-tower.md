<h1>4187 - Best Reachable Tower</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/best-reachable-tower/">best-reachable-tower</a></h2><p>You are given a 2D integer array <code>towers</code>, where <code>towers[i] = [x<sub>i</sub>, y<sub>i</sub>, q<sub>i</sub>]</code> represents the coordinates <code>(x<sub>i</sub>, y<sub>i</sub>)</code> and quality factor <code>q<sub>i</sub></code> of the <code>i<sup>th</sup></code> tower.</p>
