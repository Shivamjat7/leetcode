<h1>3889 - Minimum Cost Path with Teleportations</h1><h2>Difficulty: Hard - <a href="https://leetcode.com/problems/minimum-cost-path-with-teleportations/">minimum-cost-path-with-teleportations</a></h2><p>You are given a <code>m x n</code> 2D integer array <code>grid</code> and an integer <code>k</code>. You start at the top-left cell <code>(0, 0)</code> and your goal is to reach the bottom‐right cell <code>(m - 1, n - 1)</code>.</p>
